...
class YOLOModel(object):
    def __init__(self, verbose=0):
        ...
        self.label_list = ['gongshi']
        self.label_list_cn = ['段落公式']
        #给每个类别的候选框设置一个颜色
        ...
        #模型的名称或路径
        self.weights = 'runs/train/gongshi/weights/best.pt'      # 'yolov5s.pt'
        # self.weights = 'runs/train/exp2/weights/last.pt'      # 'yolov5s.pt'
        self.source = 'images_dir'  #图片目录
        self.img_size = 1024   #像素
        self.conf_thres = 0.3    #置信度, 大于这个置信度的才类别才取出来
